                        ...
                        <div class="notif-card <?php echo !$isRead ? 'unread' : ''; ?>">
                            ...
                            <div class="notif-content">
                                ...
                                <div class="notif-meta">
                                    ...
                                    <span><i class="far fa-clock"></i> <?php echo timeAgo(strtotime($ann['created_at'])); ?></span>
                                </div>
                            </div>
                            <?php if (!$isRead): ?>
                    ...
                    <?php foreach ($notifications as $notif): ?>
                        <div class="notif-card <?php echo !$notif['is_read'] ? 'unread' : ''; ?>">
                            <div class="notif-icon personal-icon">
                                ...
                                switch($notif['type']) {
                                    case 'reservation': $iconClass = 'fa-calendar-check'; break;
                                    case 'sitin':       $iconClass = 'fa-clock'; break;
                                    case 'reminder':    $iconClass = 'fa-bell'; break;
                                    case 'welcome':     $iconClass = 'fa-smile-wink'; break;
                            ...
                            <div class="notif-content">
                                ...
                                <div class="notif-meta">
                                    <span><i class="far fa-clock"></i> <?php echo timeAgo(strtotime($notif['created_at'])); ?></span>
                                </div>
                                <?php if ($notif['link']): ?>
                                    <a href="<?php echo $notif['link']; ?>" class="notif-link">View Details <i class="fas fa-arrow-right"></i></a>
                                <?php endif; ?>
                            </div>
                            <div class="notif-actions">
                                ...
                                <form method="POST">
                                    <input type="hidden" name="notification_id" value="<?php echo $notif['id']; ?>">
                                    <button type="submit" name="delete" class="btn-delete" onclick="return confirm('Delete this notification?')">
