...
.search-control label { color: var(--text-muted); font-size: 0.875rem; }
...
.students-table tbody tr:hover { background: rgba(255,255,255,0.04); }
...
.badge-course   { background: rgba(37,99,235,0.15);  border: 1px solid rgba(37,99,235,0.3);  color: #93c5fd; }
.badge-year     { background: rgba(16,185,129,0.12); border: 1px solid rgba(16,185,129,0.25); color: #6ee7b7; }
.badge-sessions { background: rgba(245,158,11,0.12); border: 1px solid rgba(245,158,11,0.25); color: #fcd34d; }
...
.showing-text { color: var(--text-muted); font-size: 0.875rem; }

.pagination { display: flex; gap: 0.3rem; align-items: center; flex-wrap: wrap; }
...
.empty-state i { font-size: 3rem; color: var(--text-muted); opacity: 0.4; margin-bottom: 1rem; display: block; }
...
.btn-cancel:hover { background: rgba(255,255,255,0.10); color: var(--text-primary); }
...
.confirm-icon i { font-size: 1.8rem; color: #fca5a5; }
.confirm-text { text-align: center; color: var(--text-secondary); font-size: 0.95rem; line-height: 1.6; }
.confirm-text strong { color: var(--text-primary); }

/* Fix all select dropdowns - force dark background */
select,
.entries-select,
.form-control select,
select.form-control {
...
/* For the entries dropdown specifically */
.entries-select {
    background: #1e293b !important;
...
/* For all select dropdowns in modals */
.modal-box select,
    ...
    <div class="students-main">
        ...
        <?php if (isset($_GET['msg'])): ?>
            <?php if ($_GET['msg'] === 'deleted'): ?>
                <div class="alert alert-success"><i class="fas fa-check-circle"></i> Student deleted successfully.</div>
            <?php elseif ($_GET['msg'] === 'reset'): ?>
                <div class="alert alert-warning"><i class="fas fa-redo"></i> All student sessions have been reset to 30.</div>
            <?php elseif ($_GET['msg'] === 'added'): ?>
                <div class="alert alert-success"><i class="fas fa-check-circle"></i> Student added successfully.</div>
            <?php elseif ($_GET['msg'] === 'updated'): ?>
                <div class="alert alert-success"><i class="fas fa-check-circle"></i> Student updated successfully.</div>
            <?php endif; ?>
        <?php endif; ?>
                    ...
                    <tbody>
                        <?php if (!empty($students)): ?>
                            ...
                            <tr>
                                ...
                                <td><span class="badge badge-year">Year <?php echo htmlspecialchars($s['year_level']); ?></span></td>
                                <td><span class="badge badge-course"><?php echo htmlspecialchars($s['course']); ?></span></td>
                            ...
                            <tr>
                                <td colspan="7">
                                    <div class="empty-state">
                                        ...
                                        <p><?php echo !empty($search) ? "No results for \"" . htmlspecialchars($search) . "\"." : "No students registered yet."; ?></p>
                                    </div>
                                </td>
                            </tr>
                        <?php endif; ?>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="course" class="form-control" required>
                            <option value="" style="background:#0d1829;">Select Course</option>
                            <option value="BSIT" style="background:#0d1829;">BSIT</option>
                            <option value="BSCS" style="background:#0d1829;">BSCS</option>
                            <option value="BSIS" style="background:#0d1829;">BSIS</option>
                            <option value="ACT"  style="background:#0d1829;">ACT</option>
                        </select>
                    </div>
                </div>
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="year_level" class="form-control" required>
                            <option value="" style="background:#0d1829;">Select Year</option>
                            <?php for ($y=1;$y<=4;$y++): ?>
                            <option value="<?php echo $y; ?>" style="background:#0d1829;">Year <?php echo $y; ?></option>
                            <?php endfor; ?>
                        </select>
                    </div>
                </div>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="form-label"><i class="fas fa-lock"></i> New Password
                        <small style="color:var(--text-muted);text-transform:none;font-weight:400;">(leave blank to keep current)</small>
                    </label>
        ...
        <form method="POST" action="">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="sessions" id="sessions_value" class="form-control" min="0" max="99" required>
                </div>
            </div>
            <div class="modal-footer">
...
<div class="modal-overlay" id="deleteModal">
    <div class="modal-box" style="max-width:420px;">
        ...
        <div class="modal-footer">
            ...
            <a id="delete_confirm_link" href="#" class="btn btn-danger">
                <i class="fas fa-trash"></i> Delete
            </a>
        </div>
    </div>
...
function confirmDelete(id, name) {
    ...
    document.getElementById('delete_confirm_link').href = `admin_students.php?delete=${id}`;
