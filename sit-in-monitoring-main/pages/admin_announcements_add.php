...
$pageTitle = "Add Announcement - CCS Sit-in System";
$basePath = "../";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $author = $_SESSION['user_name'] ?? 'CCS Admin';
    ...
    if (empty($title)) {
        ...
        $stmt = $pdo->prepare("INSERT INTO announcements (title, content, author, is_active) VALUES (?, ?, ?, ?)");
        $stmt->execute([$title, $content, $author, $is_active]);
        header("Location: admin_announcements.php?msg=added");
        exit();
    }
}
?>
...
<div class="add-container">
    <div class="add-main">
        ...
        <div class="page-header">
            <h1><i class="fas fa-plus-circle" style="color:#0ea5e9;margin-right:8px;"></i>Create Announcement</h1>
        ...
        <div class="form-card">
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" class="form-control" placeholder="Write your announcement here..." required></textarea>
                </div>
