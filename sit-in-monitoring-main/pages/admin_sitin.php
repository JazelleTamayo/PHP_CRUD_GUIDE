    ...
    if (empty($id_number) || empty($purpose) || empty($lab)) {
        ...
        if (!$student) {
            ...
            if ($check->fetch()) {
                ...
                $insert = $pdo->prepare("
                    INSERT INTO sit_in (user_id, id_number, name, purpose, laboratory, login_time, login_date, status)
                ...
                $success_message = "Sit-in recorded for " . htmlspecialchars($full_name) . "!";
            }
        }
    }
}

// ── Handle Timeout with Reward Points ──────────────────────────────────────
    ...
    try {
        ...
        if ($sit_in) {
            ...
            if ($give_points > 0) {
                ...
                $addNotif = $pdo->prepare("INSERT INTO notifications (user_id, type, title, message, link) VALUES (?, 'reward', 'Sit-in Completed & Reward Earned', ?, 'dashboard.php')");
...
/* Reward Points Modal - 2 OPTIONS ONLY (1 point or 0 points) */
...
.id-lookup-row { display: flex; gap: 0.5rem; }
...
<div class="alert alert-success" style="max-width:1200px;margin:100px auto 0;">
...
<!-- Reward Points Modal - ONLY 2 OPTIONS (1 point or 0 points) -->
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="student_name" class="form-control"
                           placeholder="Auto-filled after ID lookup" readonly>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="remaining_sessions"
...
function openRewardModal(sitInId, studentName) {
    ...
    // Reset to default (0 points selected)
...
function lookupStudent() {
    ...
    if (!id) { alert('Please enter an ID number first.'); return; }
